...
public:
	...
	using iterator = ArrayListIterator<value_type>;
	using const_iterator = ArrayListConstIterator<value_type>;
	...
	String(std::initializer_list<value_type> initializerList) { AddRange(initializerList); }
	template <class IteratorType>
	String(IteratorType first, IteratorType last) { AddRange(first, last); }
	...
	iterator GetBegin() { return iterator(m_data, 0); }
	const_iterator GetBegin() const { return const_iterator(m_data, 0); }
	iterator GetEnd() { return iterator(m_data, m_count); }
	const_iterator GetEnd() const { return const_iterator(m_data, m_count); }
	reverse_iterator GetReverseBegin() { return reverse_iterator(GetEnd()); }
	const_reverse_iterator GetReverseBegin() const { return const_reverse_iterator(GetEnd()); }
	reverse_iterator GetReverseEnd() { return reverse_iterator(GetBegin()); }
	const_reverse_iterator GetReverseEnd() const { return const_reverse_iterator(GetBegin()); }
	const_iterator GetConstBegin() const { return GetBegin(); }
	const_iterator GetConstEnd() const { return GetEnd(); }
	const_reverse_iterator GetConstReverseBegin() const { return GetReverseBegin(); }
	const_reverse_iterator GetConstReverseEnd() const { return GetReverseEnd(); }
	...
	const_iterator begin() const { return GetBegin(); }
